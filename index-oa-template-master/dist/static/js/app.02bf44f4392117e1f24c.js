...
/* harmony export (immutable) */ __webpack_exports__["d"] = openLink;
    ...
    methods: {
        homeGroupsOpenLink: function (item) {
            if (lock) {
                ...
                __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__lib_util_js__["d" /* openLink */])(url, function () {
                    lock = true;
                });
            }
        }
    ...
    methods: {
        openAdmin: function () {
            if (lock) {
                ...
                __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__lib_util_js__["d" /* openLink */])(adminUrl, function () {
                    lock = true;
                });
            }
        },
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_grid_vue__ = __webpack_require__(14);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__lib_env_js__ = __webpack_require__(11);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    mounted: function () {
        ...
        const signRequest = {
            url: __WEBPACK_IMPORTED_MODULE_2__lib_env_js__["a" /* OPENAPIHOST */] + '/api/jsapi-oauth',
            params: {
                href: location.href
            }
        };
    ...
    methods: {
        getUserId: function () {
            ...
            const getUserIdRequest = {
                url: __WEBPACK_IMPORTED_MODULE_2__lib_env_js__["a" /* OPENAPIHOST */] + '/api/get-user-info'
            };
        ...
        getUserInfo: function () {
            ...
            const getUserInfoRequest = {
                url: __WEBPACK_IMPORTED_MODULE_2__lib_env_js__["a" /* OPENAPIHOST */] + '/api/get',
                params: {
                    userid: this.userId
                }
            };
        ...
        getMicroApps: function () {
            ...
            const microAppsRequest = {
                url: __WEBPACK_IMPORTED_MODULE_2__lib_env_js__["a" /* OPENAPIHOST */] + '/api/get-microapp-list'
            };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__logger__ = __webpack_require__(12);
...
__WEBPACK_IMPORTED_MODULE_0_axios___default.a.interceptors.request.use(function (config) {
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__shared__["a" /* msgLog */])(config.url);
    return config;
}, function (error) {
...
function jsApiOAuth(Config, jsApiList) {
    ...
    dd.error(function (error) {
        __WEBPACK_IMPORTED_MODULE_1__logger__["a" /* default */].error('dd js api OAuth error' + JSON.stringify(error));
    });
    if (false) {
        if (!href) {
...
function getUserId(Config, corpId) {
    ...
    return new Promise(function (resolve, reject) {
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__shared__["b" /* authCode */])(corpId).then(function (result) {
...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["b"] = authCode;
/* unused harmony export isObject */
/* harmony export (immutable) */ __webpack_exports__["a"] = msgLog;
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__logger__ = __webpack_require__(12);
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }), _vm._v(" "), _vm._l((_vm.meta), function(item) {
    return (_vm.homeGroups) ? _c('div', {
      staticClass: "cell"
    }, [_c('complex-app', {
      attrs: {
        "item": item
...
//# sourceMappingURL=app.02bf44f4392117e1f24c.js.map